...
const InfoPage = () => {
  ...
  // Scroll to section based on URL hash - both on initial load and when hash changes
  useEffect(() => {
    ...
    // Scroll on initial load or hash change
    scrollToSection();

    // Also listen for hash changes in the URL (when clicking footer links while already on the page)
  ...
  }, [location.hash]); // Depend on location.hash to trigger when it changes
